...
public class SimulateLaundry implements Runnable {
    ...
    public boolean TODO2() {
      if(room.hasFreeWashers() == false && room.hasFreeDryers() == false){
        return true;
      }
    ...
    */
    public void TODO4() {
        ...
        action = JOptionPane.showOptionDialog(null,"Your balance is $x.xx. What would you like to do?", "Menu",JOptionPane.YES_NO_CANCEL_OPTION,  JOptionPane.QUESTION_MESSAGE, null, actionOptions, actionOptions[0]);
    }

    //returns true only if there are washers avilable.
    public boolean TODO5() {
      if(room.hasFreeWashers() == true){
        return true;
      }
        return false; //change this as needed
    }
    ...
    */
    public void TODO9() {
        //timeString = ... complete this
      timeString = JOptionPane.showInputDialog(null,
                                                "How long would you like to dry (in minutes)?", 
                                                "Drying time",
    ...
    */
    public void TODO13() {
        //machinesToShow = complete this
      //machinesToShow = JOptionPane.showInputDialog(null,"Which machine?", "Machine Selection",JOptionPane.YES_NO_OPTION,  JOptionPane.QUESTION_MESSAGE, null, getAll(m));
    ...
    */
    public void TODO14() {
        //machine = ... complete this 
     // machine= JOptionPane.showInputDialog(null,"Which machine?", "Machine Selection",JOptionPane.YES_NO_OPTION,  JOptionPane.QUESTION_MESSAGE, null, addMachines());
    }
